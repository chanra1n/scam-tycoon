                    ...
                    function createPanZoom(domElement, options) {
                        ...
                        function onKeyDown(e) {
                            if (panZoomModeEnabled) {
                                ...
                                var player = document.getElementById('player'); // Replace 'player' with the actual ID of your player element
                                var playerX = parseInt(player.style.left) || 0;
                                var playerY = parseInt(player.style.top) || 0;
                                ...
                                // Adjust the viewport instead of the player's position when the arrow keys are pressed
                                if (e.key === 'ArrowUp') {
                                    player.style.backgroundImage = "url('sprites/character/cat/black/back/back_loop.gif')";
                                    internalMoveBy(0, 7.5);
                                } else if (e.key === 'ArrowDown') {
                                    player.style.backgroundImage = "url('sprites/character/cat/black/front/front_loop.gif')";
                                    internalMoveBy(0, -7.5);
                                } else if (e.key === 'ArrowLeft') {
                                    player.style.backgroundImage = "url('sprites/character/cat/black/right/right_loop.gif')";
                                    internalMoveBy(7.5, 0);
                                } else if (e.key === 'ArrowRight') {
                                    player.style.backgroundImage = "url('sprites/character/cat/black/left/left_loop.gif')";
                                    internalMoveBy(-7.5, 0);
                                }
                            }
